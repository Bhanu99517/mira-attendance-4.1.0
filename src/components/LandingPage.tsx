...
const LandingPage: React.FC<{ onLogin: () => void; onPrivacy: () => void }> = ({ onLogin, onPrivacy }) => {
            ...
            <footer className="py-12 bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 px-4">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex gap-6">
                        ...
                        <button onClick={onPrivacy} className="text-sm font-bold text-primary-500 hover:underline">Privacy Policy</button>
                    </div>
                </div>
            </footer>
        </div>
